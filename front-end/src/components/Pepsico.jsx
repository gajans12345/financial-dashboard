...
export function PepsiCoMain() {
  ...
  return (
    <div style={{ 
      ...
      <StackedBarChart company="Pepsico" />
      <RadarChart company="Pepsico" />
      <CurrentAssetsPieChart company="Pepsico" />
      <NonCurrentAssetsPieChart company="Pepsico" />
      <FlowChart company="Pepsico" />
    </div>
  );
}
