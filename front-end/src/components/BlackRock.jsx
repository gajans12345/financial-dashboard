...
export function BlackRockMain() {
  ...
  return (
    <div style={{ 
      ...
      <StackedBarChart company="BlackRock" />
      <RadarChart company="BlackRock" />
      <CurrentAssetsPieChart company="BlackRock" />
      <NonCurrentAssetsPieChart company="BlackRock" />
      <FlowChart company="BlackRock" />
    </div>
  );
}
